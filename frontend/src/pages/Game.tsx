...
import ecopontoAzul from '../assets/ecopontoazul.png';
import ecopontoAmarelo from '../assets/ecopontoamarelo.png';
import ecopontoVerde from '../assets/ecopontoverde.png';
import lixoOrganico from '../assets/lixoorganico.png';
